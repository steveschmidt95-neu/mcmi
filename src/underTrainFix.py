...
class MIL():
    ...
    def __init__(self, fc_units = 50, num_classes=4, width1=38, width2=18, width3=16, filters_layer1=12, 
        ...
        if small_train:
            ...
            #self.train_data_total.cores_list = ['ROI14TMA1train', 'ROI9TMA1train', 'ROI12TMA2train', 'ROI24TMA1train'] # 1 of each
            #self.train_data_total.cores_list = ['ROI14TMA1train', 'ROI9TMA1train', 'ROI12TMA2train', 'ROI24TMA1train', 'ROI8TMA2train',  'ROI20TMA1train', 'ROI11TMA2train', 'ROI10TMA1train'] # 2 of each
            #self.train_data_total.cores_list = ['ROI14TMA1train', 'ROI9TMA1train', 'ROI12TMA2train', 'ROI24TMA1train', 'ROI8TMA2train',  'ROI20TMA1train', 'ROI11TMA2train', 'ROI10TMA1train', 'ROI7TMA2train', 'ROI2TMA1train', 'ROI8TMA1train', 'ROI11TMA1train'] # 3 of each
            self.train_data_total.cores_list = ['ROI14TMA1train', 'ROI9TMA1train', 'ROI12TMA2train', 'ROI24TMA1train', 'ROI8TMA2train',  'ROI20TMA1train', 'ROI11TMA2train', 'ROI10TMA1train', 'ROI7TMA2train', 'ROI2TMA1train', 'ROI8TMA1train', 'ROI11TMA1train', 'ROI6TMA1train', 'ROI21TMA2train','ROI1TMA2train', 'ROI15TMA2train'] # 4 of each
            #self.train_data_total.cores_list = ['ROI14TMA1train', 'ROI9TMA1train', 'ROI12TMA2train', 'ROI24TMA1train', 'ROI8TMA2train',  'ROI20TMA1train', 'ROI11TMA2train', 'ROI10TMA1train', 'ROI7TMA2train', 'ROI2TMA1train', 'ROI8TMA1train', 'ROI11TMA1train', 'ROI6TMA1train', 'ROI21TMA2train','ROI1TMA2train', 'ROI15TMA2train', 'ROI9TMA2train','ROI23TMA1train', 'ROI16TMA1train', 'ROI15TMA1train'] # 5 of each
